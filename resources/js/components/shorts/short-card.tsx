...
const ShortCard = ({ short, onNext, seconds }: Props) => {
    const bgStyle = resolveBackground(short.background);

    return (
        <Card
            className="relative h-[calc(100vh-8rem)] w-full max-w-md overflow-hidden rounded-[10px] p-4"
            style={bgStyle.container as CSSProperties}
        >
